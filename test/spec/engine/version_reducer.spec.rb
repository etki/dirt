require 'rspec'
require 'engine/version_reducer'
require 'model/version'
require 'pathname'

def factory
  Semble::Engine::VersionReducer.new
end
...
RSpec.describe Semble::Engine::VersionReducer, '#reduce' do
  context 'with empty array on input' do
    it 'should throw exception' do
      expect { factory.reduce() }.to raise_error(ArgumentError)
    end
  end
  ...
  context 'with several versions' do
    it 'should combine them' do
      ...
      result = factory.reduce(spec_a, spec_b, spec_c)
